...
void event(SDL_Window *win, SDL_Renderer *rend) {
    ...
    //SDL_Texture *hero_tex = IMG_LoadTexture(rend, "/Users/ymrozek/Desktop/EndGameCollab/assets/hero.png");
    //SDL_Texture *back_tex = IMG_LoadTexture(rend, "/Users/ymrozek/Desktop/EndGameCollab/assets/images.jpg");
